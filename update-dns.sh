...
curl --get https://server3.iqnecthosting.com:2083/execute/DNS/mass_edit_zone -u "dsaadmin:$FTP_PASSWORD" --data "zone=dougschmittantiques.com" --data "serial=$DOMAIN_SERIAL" --data "edit={\"line_index\":$DOMAIN_INDEX,\"dname\":\"_acme-challenge\",\"ttl\":6400,\"record_type\":\"TXT\",\"data\":[\"$CERTBOT_VALIDATION\"]}" 
